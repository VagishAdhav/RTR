...
int initialise(void)
{
    ...
    glClearColor(0.902f, 0.902f, 0.980f, 0.0f);

    // load textures
    if (loadGLTexture(&textureMirror, MAKEINTRESOURCE(ID_BITMAP_MIRROR)) == FALSE)
    {
        fprintf(gpFile, "loadGLTexture failed for ID_BITMAP_MIRROR\n");
        return -6;
    }
