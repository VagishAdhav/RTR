...
// rotation angles
GLdouble gldAngleRectangle = 360.0f;
GLdouble gldAngleTriangle = 0.0f;
...
int main(void)
{
    ...
    // set window title
    XStoreName(gpDisplay, window, "VVA:XWindow - Prespective Triangle");
...
void display(void)
{
    ...
    glRotatef(gldAngleTriangle, 0.0f, 1.0f, 0.0f);
    // draw the triangle
    ...
    glRotatef(gldAngleRectangle, 1.0f, 0.0f, 0.0f);
