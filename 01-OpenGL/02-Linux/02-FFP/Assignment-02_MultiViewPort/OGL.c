...
void resize(int width, int height)
{
    ...
    // set the viewport
    glViewport((GLint)((float)width * (float)xScale),
               (GLint)((float)height * (float)yScale),
               (GLsizei)((float)width * (float)widthScale),
               (GLsizei)((float)height * (float)heightScale));
