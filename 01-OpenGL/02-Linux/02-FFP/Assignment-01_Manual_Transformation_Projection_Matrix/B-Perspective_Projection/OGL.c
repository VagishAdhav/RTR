...
int main(void)
{
    ...
    // set window title
    XStoreName(gpDisplay, window, "VVA:XWindow - Perspective Triangle");
...
int initialise(void)
{
    ...
    translationMatrix[14] = -3.0f; // glTranslate z
...
void resize(int width, int height)
{
    ...
    prespectiveMatrix[0] = (2.0f * fNear)/(fRight - fLeft);
    prespectiveMatrix[1] = 0.0f;
    prespectiveMatrix[2] = 0.0f;
    prespectiveMatrix[3] = 0.0f;

    prespectiveMatrix[4] = 0.0f;
    prespectiveMatrix[5] = (2.0f * fNear)/(fTop - fBottom);
    prespectiveMatrix[6] = 0.0f;
    prespectiveMatrix[7] = 0.0f;

    prespectiveMatrix[8] = (fRight + fLeft)/(fRight - fLeft);
    prespectiveMatrix[9] = (fTop + fBottom)/(fTop - fBottom);
    prespectiveMatrix[10]= -(fFar + fNear)/(fFar - fNear);
    prespectiveMatrix[11]= -1.0f;

    prespectiveMatrix[12]= 0.0f; 
    prespectiveMatrix[13]= 0.0f;
    prespectiveMatrix[14]= -2.0f * fFar * fNear/ (fFar - fNear);
    prespectiveMatrix[15]= 0.0f;

    glMultMatrixf(prespectiveMatrix);
