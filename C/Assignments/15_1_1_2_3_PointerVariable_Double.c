...
int main(void)
{
    ...
    double vva_num_vva;
    double* vva_ptr = NULL; // declaration method 2, vva_ptr is a variable of type double*

    //code
    vva_num_vva = 2.34343434f;
    
    printf("\n\n");

    printf("***** BEFORE vva_ptr = &vva_num_vva *******\n\n");
    printf("Value of 'vva_num_vva'              = %lf\n\n", vva_num_vva);
    printf("Address of 'vva_num_vva'            = %p\n\n", &vva_num_vva);
    printf("Values at address of 'vva_num_vva'  = %lf\n\n", *(&vva_num_vva));
