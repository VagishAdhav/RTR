...
int main(void)
{
    ...
    struct MyPoint
    {
        int x;
        int y;
    }vva_point; //declaring a single variable of type 'struct MyPoint' locally
    ...
    }vva_point_properties; //declaring a single variable of type 'struct MyPointProperties' locally
