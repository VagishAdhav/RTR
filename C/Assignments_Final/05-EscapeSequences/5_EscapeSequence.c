...
int main(void)
{
    ...
    printf("\"This is a_vva double quoted output\" done using \\\" \\\" escape sequence\n\n");
    ...
    // 0x41 is the hexadecimal code for letter 'A' , 'xhh' is the placeholder for 'x' followed by two digits (hh), along together forming a_vva hexadecimal number.
