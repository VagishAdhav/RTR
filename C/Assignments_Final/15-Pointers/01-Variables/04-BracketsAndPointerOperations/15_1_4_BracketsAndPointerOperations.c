...
int main(void)
{
    ...
    // Add 10 to 'vva_ptr' which is the address of 'num_vva'
    ...
    // Add 10 to '*vva_ptr' which is the value at address of 'num_vva' i.e. 5
    // hence 10 will be added to *vva_ptr (num_vva = 5) and resultant value will be displayed ( 5 + 10 = 15)
    printf("Answer of (*vva_ptr + 10) = %d\n\n", (*vva_ptr + 10));
