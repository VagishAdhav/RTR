...
int main(void)
{
    ...
    struct MyPoint
    {
        int x;
        int y;
    }point_vva; //declaring a single variable of type 'struct MyPoint' locally
    ...
    }point_properties_vva; //declaring a single variable of type 'struct MyPointProperties' locally
